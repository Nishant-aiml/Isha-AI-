...
$core_benchmarks = @(
    ...
    "interruption_resilience_policy_benchmark", "total_storage_governance_benchmark", "playstore_readiness_policy_benchmark",
    "telemetry_export_benchmark"
)
